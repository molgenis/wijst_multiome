...
```{r caqtl_combined_replication_plot, include=TRUE, fig.width=12, fig.height=12}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
caqtl_combined_celltype_stat_p <- plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('n_sig_both' = 'N sig both: ', 'n_sig_tested' = 'N test both: ', 'rb_emp_nom' = 'nom rep rb: '), colour_column = 'rb_emp_nom', category_plot_order = c('B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 4) +
  xlab('Cell type replicating') +
  ylab('Cell type replicating in') +
  ggtitle('Replication of caQTLs across cell types') +
  labs(fill="Rb") +
  theme(
    # X label font size
...
# save the figure
ggsave('~/plots/mo_caqtl_celltype_replication.pdf', plot = caqtl_combined_celltype_stat_p, width = 12, height = 12)
...
# check replication in caQTLs across cell types
#saveRDS(eqtl_combined_celltype_replication, '~/rds/eqtl_combined_celltype_replication')
...
```{r eqtl_combined_replication_plot, include=TRUE, fig.width=12, fig.height=12}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
eqtl_combined_celltype_stat_p <- plot_replication_stats(eqtl_combined_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('n_sig_both' = 'N sig both: ', 'n_sig_tested' = 'N test both: ', 'rb_emp_nom' = 'nom rep rb: '), colour_column = 'rb_emp_nom', category_plot_order = c('B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 4) +
  xlab('Cell type replicating') +
  ylab('Cell type replicating in') +
  ggtitle('Replication of eQTLs across cell types') +
  labs(fill="Rb") +
  theme(
    # X label font size
    axis.title.x = element_text(size = 20), 
...
# save the figure
ggsave('~/plots/mo_eqtl_celltype_replication.pdf', plot = eqtl_combined_celltype_stat_p, width = 12, height = 12)
