...
featureFilterFile = config['feature_filter_loc']
if config['feature_filter_prepend'] is None:
    formatted_path = f"{featureFilterFile}{ct}{config['feature_filter_append']}"
else:
    formatted_path = f"{featureFilterFile}{config['feature_filter_prepend']}{ct}{config['feature_filter_append']}"
featureFilterFile = Path(formatted_path)
