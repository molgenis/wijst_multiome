...
# check replication in caQTLs across cell types
caqtl_lcl_celltype_stat_p_alt <- plot_replication_stats(lcl_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('rb_emp_all' = ''), colour_column = 'rb_emp_all', category_plot_order = c('LCL', 'B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 8, legendless = T, matching_value_to_text=list('n_sig_tested' = '')) +
...
caqtl_lcl_celltype_stat_p_alt_legend <- get_legend(plot_replication_stats(lcl_celltype_stats, mid_value = 0.5, colour_column = 'rb_emp_all', legendless = F) + labs(fill="Rb"))
# and save those
