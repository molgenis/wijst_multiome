---
title: "mo_check_caqtl_correlations_celltypes"
author: "Roy Oelen"
date: "2025-12-23"
...
# Name: mo_check_caqtl_correlations_celltypes.Rmd
...
# location of caQTL
caqtl_output_combined_loc <- '/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/qtl/caqtl/sc-eqtlgen/output/L1/combined/'

```

```{r caqtl_combined_replication, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
caqtl_combined_celltype_replication <- match_qtl_outputs_each(
  caqtl_output_combined_loc, 
  caqtl_output_combined_loc
)

```

```{r caqtl_combined_replication_save, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
#saveRDS(caqtl_combined_celltype_replication, '~/rds/caqtl_combined_celltype_replication.rds')
# for(replication_name in names(caqtl_combined_celltype_replication)) {
#   replication_save_loc <- paste0('/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/qtl/eqtl/replication/celltypes/mo_matched_caqtl_', replication_name, '.tsv.gz')
#   write.table(caqtl_combined_celltype_replication[[replication_save_loc]], gzfile(replication_save_loc), row.names = F, col.names = T, sep = '\t')
#   mdfiver::create_md5_for_file(replication_save_loc)
# }

```

```{r caqtl_combined_replication_read, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
caqtl_combined_celltype_replication <- readRDS('~/rds/caqtl_combined_celltype_replication.rds')

```

```{r caqtl_combined_replication_stats, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# check replication in caQTLs across cell types
caqtl_combined_celltype_stats <- get_stats_qtl_matches(caqtl_combined_celltype_replication)
...
# check replication in caQTLs across cell types
#saveRDS(caqtl_combined_celltype_stats, '~/caqtl_combined_celltype_stats.rds')
caqtl_replication_stats_loc <- '/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/qtl/eqtl/replication/celltypes/mo_caqtl_replication_stats.tsv.gz'
# write.table(caqtl_combined_celltype_stats, gzfile(caqtl_replication_stats_loc), row.names = F, col.names = T, sep = '\t')
# mdfiver::create_md5_for_file(caqtl_replication_stats_loc)
...
# check replication in caQTLs across cell types
caqtl_combined_celltype_stats <- fread(caqtl_replication_stats_loc, header = T, sep = '\t')

```

```{r caqtl_combined_replication_testedfrac, include=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# add the fraction tested
caqtl_combined_celltype_stats[['frac_tested']] <- apply(caqtl_combined_celltype_stats, 1, function(x) {
  # get what we are replicating
  replicating <- x[['replicating']]
  # get the significant number for that one, which is against itself
  replicating_sig_n <- caqtl_combined_celltype_stats[
    caqtl_combined_celltype_stats[['replicating']] == replicating &
    caqtl_combined_celltype_stats[['replicating_in']] == replicating  , ][['n_sig_both']][1]
...
```{r caqtl_combined_replication_plot, include=TRUE, fig.width=8, fig.height=8}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# # check replication in caQTLs across cell types
caqtl_combined_celltype_stat_p_sup <- plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('n_sig_tested' = 'test: ', 'n_sig_both' = 'sig: '), colour_column = 'frac_tested', category_plot_order = c('B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 5, legendless = T, matching_value_to_text=list('n_sig_tested' = 'sig: ')) + 
xlab('Cell type replicating') +
  ylab('Cell type replicating in') +
  ggtitle('Replication of caQTLs') +
...
# check replication in caQTLs across cell types
caqtl_combined_celltype_stat_p <- plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('rb_emp_all' = 'Rb: '), colour_column = 'rb_emp_all', category_plot_order = c('B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 4, legendless = T) +
  xlab('Cell type replicating') +
  ylab('Cell type replicating in') +
  ggtitle('Replication of caQTLs') +
  labs(fill="Rb") +
...
# check replication in caQTLs across cell types
caqtl_combined_celltype_stat_p_alt <- plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, comparing_value_to_text=list('rb_emp_all' = ''), colour_column = 'rb_emp_all', category_plot_order = c('B', 'CD4+ T', 'CD8+ T', 'NK', 'DC', 'Monocyte'), text_size = 8, legendless = T, matching_value_to_text=list('n_sig_tested' = '')) +
  xlab('Cell type replicating') +
  ylab('Cell type replicating in') +
  ggtitle('Replication of caQTLs') +
  labs(fill="Rb") +
...
# save the figures
ggsave('~/plots/mo_caqtl_celltype_replication.pdf', plot = caqtl_combined_celltype_stat_p, width = 8, height = 8)
ggsave('~/plots/mo_caqtl_celltype_replication_alt.pdf', plot = caqtl_combined_celltype_stat_p_alt, width = 8, height = 8)
ggsave('~/plots/mo_caqtl_celltype_replication_sup.pdf', plot = caqtl_combined_celltype_stat_p_sup, width = 8, height = 8)

# display the figure
caqtl_combined_celltype_stat_p
caqtl_combined_celltype_stat_p_alt
caqtl_combined_celltype_stat_p_sup

# extract legends as well
caqtl_combined_celltype_stat_p_alt_legend <- get_legend(plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, colour_column = 'rb_emp_all', legendless = F) + labs(fill="Rb"))
caqtl_combined_celltype_stat_p_sup_legend <- get_legend(plot_replication_stats(caqtl_combined_celltype_stats, mid_value = 0.5, colour_column = 'frac_tested', legendless = F) + labs(fill="Fraction\nTested"))
# and save those
ggsave('~/plots/mo_caqtl_celltype_replication_alt_legend.pdf', plot = caqtl_combined_celltype_stat_p_alt_legend, width = 1, height = 2)
ggsave('~/plots/mo_caqtl_celltype_replication_sup_legend.pdf', plot = caqtl_combined_celltype_stat_p_sup_legend, width = 1, height = 2)
