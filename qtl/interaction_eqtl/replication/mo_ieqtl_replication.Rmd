...
get_stats_qtl_matches <- function(table_per_match, 
                                  replicating_name, 
                                  replicating_in_name,
  ...
  for (combination in names(table_per_match)) {
    ...
    if (replicating_name == replicating_in_name) {
      ...
      # subset to emperical in one
      replication_table_emp1 <- replication_table[
          replication_table[[paste(replicating_name, significance_column_replicating_emperical, sep = '_')]] < significance_cutoff_replicating_emperical,  
      ]
      # and the beta
      beta_replicating_in <- replication_table_emp1[[paste(replicating_in_name, beta_column_replicating_in, sep = '_')]]
      # check which have the same allelic direction
      alleles_differ_locs <- which(replication_table_emp1[[paste(replicating_name, allele_column_replicating, sep = '_')]] != replication_table_emp1[[paste(replicating_in_name, allele_column_replicating_in, sep = '_')]])
      ...
      # calculate rb
      emperical_to_all_rb_table <- calcu_cor_true(b1 = replication_table_emp1[[paste(replicating_name, beta_column_replicating, sep = '_')]], se1 = replication_table_emp1[[paste(replicating_name, se_column_replicating, sep = '_')]], b2 = beta_replicating_in, se2 = replication_table_emp1[[paste(replicating_in_name, se_column_replicating_in, sep = '_')]])
      emperical_to_all_rb <- emperical_to_all_rb_table[1, 'r']
...
nc2022_loc <- '/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/qtl/interaction_eqtl/sc-eqtlgen/replication/output/nc2022/ut_and_24hca_significant/24hCA/'
nc2022_allcond_loc <- '/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/qtl/interaction_eqtl/sc-eqtlgen/replication/output/nc2022/ut_and_24hca_significant/24h/'
...
mo_vs_nc2022_allcond_replication_summary <- qtl_sumstats_to_table(mo_vs_nc2022_allcond_ieqtls, significance_column_replicating_in = 'nc2022_bh_significant')
