...
# Name: mo_create_limix_interaction_qtl_input.R
...
do_limix_input_pipeline(
  ...
  output_loc='/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/qtl/interaction_eqtl/sc-eqtlgen/input/L1/combined/',
