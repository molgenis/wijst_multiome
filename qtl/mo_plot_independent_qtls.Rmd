...
#' 
get_output_per_celltype_limix <- function(qtl_output_loc, output_file='qtl_results_all_qval_allchroms_fdr005_significant_cs.tsv.gz', gene_column='feature_id', significance_column='feature_q_value', significance_cutoff=0.05, verbose=T) {
...
for (ct in names(eqtl_outputs)) {
  ...
  #eqtl_output_ct <- eqtl_output_ct[eqtl_output_ct[['p_value']] < eqtl_output_ct[['pval_nominal_threshold_global']], ]
...
for (ct in names(caqtl_outputs)) {
  ...
  # filter on nominal threshold
  # caqtl_output_ct <- caqtl_output_ct[eqtl_output_ct[['p_value']] < caqtl_output_ct[['pval_nominal_threshold_global']], ]
