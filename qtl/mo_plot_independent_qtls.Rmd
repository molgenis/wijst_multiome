...
for (ct in intersect(names(eqtl_outputs_filtered), names(caqtl_outputs_filtered))) {
  ...
  eqtl_output_ct <- eqtl_output_ct[, c('snp_id', 'feature_id')]
  caqtl_output_ct <- caqtl_output_ct[, c('snp_id', 'feature_id')]
  # rename the columns
  colnames(eqtl_output_ct) <- c('snp_id', 'feature_eqtl')
  colnames(caqtl_output_ct) <- c('snp_id', 'feature_caqtl')
  # merge them
