...
p_eqtl_opposite <- plot_qtls('ARL17B', '17:45614972:T:C', feature_table = eqtl_files_per_cond$UT$monocyte, genotypes = genotypes, sample_mapping = eqtl_smf, better_colors = T, legendless = T) + ggtitle('rs2668709 affecting ALR17B expression\ninmonocytes') + xlab('genotype') + ylab('ALR17B expression')
p_caqtl_opposite <- plot_qtls('chr17-45585724-45587049', '17:45614972:T:C', feature_table = caqtl_files_per_cond$UT$monocyte, genotypes = genotypes, sample_mapping = eqtl_smf, better_colors = T, legendless = T) + ggtitle('rs2668709 affecting chr17-45585724-45587049 accessibility\ninmonocytes') + xlab('genotype') + ylab('chr17-45585724-45587049 accessibility')
...
p_eqtl_same <- plot_qtls('AL139042.1', 'rs9353559', feature_table = eqtl_files_per_cond$UT$monocyte, genotypes = genotypes, sample_mapping = eqtl_smf, better_colors = T, legendless = T) + ggtitle('rs9353559 affecting AL139042.1 expression\ninmonocytes') + xlab('genotype') + ylab('AL139042.1 expression')
p_caqtl_same <- plot_qtls('chr6-88442655-88443459', '6:88449573:C:G', feature_table = caqtl_files_per_cond$UT$monocyte, genotypes = genotypes, sample_mapping = eqtl_smf, better_colors = T, legendless = T) + ggtitle('rs9353559 affecting chr6-88442655-88443459 accessibility\ninmonocytes') + xlab('genotype') + ylab('chr6-88442655-88443459 accessibility')
