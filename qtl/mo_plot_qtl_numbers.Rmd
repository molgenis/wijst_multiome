...
#' 
get_egene_numbers_per_celltype_limix <- function(qtl_output_loc, output_file='qtl_results_all.txt.gz', gene_column='feature_id', significance_column='empirical_feature_p_value', significance_cutoff=0.05, verbose=T) {
...
caqtl_peak_numbers <- get_egene_numbers_per_celltype_limix(caqtl_output_loc, output_file = 'qtl_results_all_fdr01_significant.txt.gz')
...
# get the number of ca peaks
eqtl_gene_numbers <- get_egene_numbers_per_celltype_limix(eqtl_output_loc, output_file = 'qtl_results_all_fdr01_significant.txt.gz')

```

```{r get_capeak_numbers_plots, include=TRUE, fig.width=7, fig.height=7}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# make a plot of the numbers
p_caqtl_peak_numbers <- egene_numbers_to_plot(caqtl_peak_numbers, legendless = T, use_color_dict = T) +
...
```{r get_egene_numbers_plots, include=TRUE, fig.width=10, fig.height=10}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)
...
mono_caqtl_significant_loc <- paste(caqtl_output_loc, '/', 'monocyte', '/', 'qtl_results_all_fdr01_significant.txt.gz', sep = '')
# read the table
...
# location of mono ca output
mono_eqtl_significant_loc <- paste(eqtl_output_loc, '/', 'Mono', '/', 'qtl_results_all_fdr01_significant.txt.gz', sep = '')
# read the table
mono_eqtl_significant <- fread(mono_eqtl_significant_loc, header = T, sep = '\t')

```

```{r merge_qtls_mono, include=TRUE, fig.width=10, fig.height=10}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE)

# add new columns
mono_eqtl_significant[['beta_e']] <- mono_eqtl_significant[['beta']]
mono_eqtl_significant[['empirical_feature_p_value_e']] <- mono_eqtl_significant[['empirical_feature_p_value']]
mono_caqtl_significant[['beta_ca']] <- mono_caqtl_significant[['beta']]
mono_caqtl_significant[['empirical_feature_p_value_ca']] <- mono_caqtl_significant[['empirical_feature_p_value']]
# merge the things we care about
mono_qtl_significant <- merge(mono_eqtl_significant[mono_eqtl_significant[['empirical_feature_p_value_e']] < 0.05, c('snp_id', 'beta_e', 'empirical_feature_p_value_e')],
                              mono_caqtl_significant[mono_caqtl_significant[['empirical_feature_p_value_ca']] < 0.05, c('snp_id', 'beta_ca', 'empirical_feature_p_value_ca')], by = 'snp_id', all = F)
