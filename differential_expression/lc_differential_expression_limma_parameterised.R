...
############################################################################################################################
# Authors: Roy Oelen
# Name: lc_differential_expression_limma_parameterised.R
...
#' @param condition_combinations named list of vectors which to pairwise compare e.g. list('LONG_COVID_final' = c('case', 'control'))
...
dream_pairwise <- function(seurat_object, output_loc, condition_combinations, aggregates=c('sample_final', 'LONG_COVID_final'), fixed_effects=c('LONG_COVID_final'), random_effects=c('sample_final'), minimal_cells=0, min_numi=200, minimal_complexity=5000, verbose=T){
...
do_limma_dream_pairwise_per_celltype <- function(seurat_object, output_loc, condition_combinations=list('LONG_COVID_final' =  c('case', 'control')), celltype_column='cell_type_final', cell_types_to_use=NULL, aggregates=c('sample_final', 'LONG_COVID_final'), fixed_effects=c('LONG_COVID_final'), random_effects=c('sample_final'), minimal_cells=0, min_numi=200, minimal_complexity=5000, verbose=T){
...
do_debug <- function() {
  # fill the opt
  opt <- list()
  opt[['out']] <- '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/differential_expression/limma_dream/output/LONG_COVID/'
  opt[['file']] <- '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_all_20240619_seuratv5_annotated_agesexcovid_monocyte_UT.rds'
