...
############################################################################################################################
# Authors: Roy Oelen
# Name: mo_differential_accessibility_topics.R
# Function: 
############################################################################################################################
...
do_debug <- function() {
  ...
  opt[['threads']] <- 20
  opt[['permute']] <- F
  opt[['topic_ann']] <- '/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/differential_accessibility/topic_annotations/mo_topic_20_otsu.tsv'
  ...
  for(topic in colnames(topic_ann)){
