...
# Function: perform differential accessible region (DAR) analysis using Limma Dream
############################################################################################################################
...
dream_pairwise <- function(seurat_object, output_loc, condition_combinations, aggregates=c('sample_final', 'condition_final'), fixed_effects=c('condition_final'), random_effects=c('sample_final'), minimal_cells=0, min_peaks=200, minimal_complexity=5000, min_pct=0.001, verbose=T){
  # set assay
