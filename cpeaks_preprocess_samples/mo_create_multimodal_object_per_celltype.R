...
saveRDS(monocyte_multimodal, '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_multimodal_monocyte.rds')
...
saveRDS(cd4t_multimodal, '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_multimodal_cd4t.rds')
...
saveRDS(cd8t_multimodal, '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_multimodal_cd8t.rds')
...
saveRDS(dc_multimodal, '/groups/umcg-franke-scrna/tmp03/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_multimodal_dc.rds')
