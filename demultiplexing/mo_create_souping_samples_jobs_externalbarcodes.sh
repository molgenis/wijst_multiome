...
OUTPUT_DIR="/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/demultiplexing/souporcell/souporcell_output/barcode_filtered/"
...
EXTERNAL_BARCODES_LOC='/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/demultiplexing/valid_barcodes/'
...
#    nr_of_samples=${#array[@]}
    nr_of_samples=8
    # get the barcode
    barcode=${EXTERNAL_BARCODES_LOC}'/'${lane}'.tsv'
