...
###################################################################
#Script Name	  : mo_subset_for_genotype_correlations.sh
#Description	  : create subset the genotype file to have the genotypes per lane for demultiplexing
#Args           :
#Author       	: Roy Oelen
###################################################################

# the location of the full genotype file
FULL_GENO_FILE='/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/genotype/imputed_hg38_info_filled_genfiltered.vcf.gz'
