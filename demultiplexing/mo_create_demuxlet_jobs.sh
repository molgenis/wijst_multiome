...
BAM_DIR="/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/demultiplexing/popscle_tools_filtered/alignment/filtered_gex_alignment/"
INDIVIDUAL_GENOTYPES="/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/genotype/genotype_per_lane/"
OUTPUT_DIR="/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/demultiplexing/demuxlet/demuxlet_output/gex/"
JOB_DIR="/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/demultiplexing/demuxlet/jobs/gex/"
...
for dir in "$LANES_DIR"/*lane*/ ; do
    ...
    output_job=${JOB_DIR}"/demux_gex_"${lane_id}"_SBATCH.sh"
...
#SBATCH --get-user-env=L
	set -e
        ${DEMUXLET_CMD} \\
                ...
                --tag-UMI ${TAG_UMI} \\
                --field ${FIELD} \\
                --vcf ${INDIVIDUAL_GENOTYPES}mo_gex_bamsorted_${lane_id}_maf005.vcf.gz \\
