...
deconstructed_corrected_matrices_loc <- '/groups/umcg-franke-scrna/tmp01/projects/multiome/ongoing/scanpy_preprocess_samples/deconstructed/'

# location of where to place the objects
seurat_objects_loc <- '/groups/umcg-franke-scrna/tmp01/projects/multiome/ongoing/seurat_preprocess_samples/objects/perlane/seuratv4/'
