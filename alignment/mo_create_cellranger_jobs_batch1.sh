...
###################################################################
#Script Name	  : mo_create_cellranger_jobs_batch1.sh
#Description	  : create SBATCH jobs scripts to do alignment of the sequence data
#Author       	: Roy Oelen
###################################################################
...
SEQUENCE_LANES_LOC='/groups/umcg-franke-scrna/tmp02/projects/multiome/raw/rna/sequence_data/'
SAMPLE_SHEET_LOC='/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/metadata/mo_sample_sheet_batch1.tsv'
OUTPUT_LOC='/groups/umcg-franke-scrna/tmp02/projects/multiome/processed/rna/alignment/b38/include_introns/'
JOB_DIR='/groups/umcg-franke-scrna/tmp02/projects/multiome/processed/rna/alignment/jobs/b38/include_introns/'
