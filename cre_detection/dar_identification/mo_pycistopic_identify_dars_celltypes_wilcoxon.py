"""
mo_pycistopic_identify_dars_celltypes_wilcoxon.py

This script is used to identify DARs specifically for cell types, using the Wilcoxon method
...
# location to store the object
markers_loc = '/scratch/hb-functionalgenomics/projects/multiome/ongoing/scenicplus_workdir/pycistopic/dar_detection/merged_major_and_minor_celltypes_120topics/wilcoxon/merged_major_and_minor_celltypes_120topics_celltype_dars.joblib'
