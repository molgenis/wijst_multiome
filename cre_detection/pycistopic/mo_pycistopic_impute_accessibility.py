...
# location to store the object
pycistopic_object_wimpnorm_loc = '/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/scenicplus_workdir/pycistopic/objects/merged_major_and_minor_celltypes_120topics_impnorm.pkl'

# save the object
with open(pycistopic_object_wimpnorm_loc, 'wb') as f:
   pickle.dump(normalized_imputed_acc_obj, f)
