...
############################################################################################################################
# Authors: Roy Oelen
# Name: mo_correlate_expression_to_activity_onek1k.R
# Function: correlate TF expression to inferred TF activity in the onek1k dataset
############################################################################################################################
...
seurat_object_loc <- paste0('/groups/umcg-franke-scrna/tmp04/external_datasets/onek1k/seurat_objects/onek1k_major_cts.rds')
# read the object
...
# then plot
p_scenic_tf_expression_activity_correlations_onek1k <- plot_grid(
  ggplot(
    data = cor_tf_ereg,
    mapping = aes(
      x=dataset, 
...
# show the plot
p_scenic_tf_expression_activity_correlations_onek1k
# and save the result
ggsave(filename = '~/multiome/plots/mo_scenic_tf_expression_activity_correlations_onek1k.pdf', plot = p_scenic_tf_expression_activity_correlations_onek1k, width = 5, height = 18)
...
# show the plot
p_scenic_tf_expression_activity_correlation_density_onek1k
# and save the result
