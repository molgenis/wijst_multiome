...
############################################################################################################################
# Authors: Roy Oelen
# Name: mo_create_hybrid_cre_inputs_rna.R
# Function: create single-cell LIMIX input files
# Example: 
# Rscript mo_create_hybrid_cre_inputs_rna.R \
# --in /groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/seurat_preprocess_samples/objects/ \
# --out /groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/cre_detection/limix_sc/input/L1/all/ \
...
if (debug) {
  ...
  ct_object_loc <- '/groups/umcg-franke-scrna/tmp04/projects/multiome/ongoing/seurat_preprocess_samples/objects/mo_all_20250625_seuratv5_annotated_agesexcovid_unannotated.rds'
