...
# write the result
overlap_qtls_loc <- '/groups/umcg-franke-scrna/tmp02/projects/multiome/ongoing/qtl/colocalization/eqtl_caqtl/ut_and_24hca_significant/mo_eqtl_cqtl_coloc_and_overlapping.tsv.gz'
# get the overlap
...
scenic_output[['is_tf_ieqtl']] <- paste(scenic_output[['Gene_signature_name']], scenic_output[['Gene']]) %in% paste(tf_ieqtls_sig[['region']], tf_ieqtls_sig[['gene']])
