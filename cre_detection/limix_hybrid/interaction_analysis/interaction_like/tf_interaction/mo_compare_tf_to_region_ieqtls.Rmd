...
plot_concondance(tf_eqtl_region_ieqtls_overlap[tf_eqtl_rep_region_ieqtls_overlap[['is_eqtl']] & !(tf_eqtl_rep_region_ieqtls_overlap[['is_caqtl']]), ], d1_effect_column = 'region:genotype_beta.y_directed', d2_effect_column = 'region:genotype_beta.x_directed') + ggtitle('only eQTL i-egene beta')
